      ...
      <main className="py-14 sm:py-[27px] lg:py-0 shadow-sm rounded bg-[#F9FAFB]">
        <section className="px-3 py-12 sm:py-16 sm:px-4 lg:flex lg:gap-8 lg:px-24 lg:py-0">
          <div className="lg:pt-[206px]">
            ...
            <p className="mb-8 sm:mb-[64px] text-lg font-normal text-neutral-600 sm:text-xl lg:mt-[3px] lg:mb-[63px]">
          ...
          <img
            src={PrismImg}
            className="w-[319px] h-[264px] sm:w-[704px] sm:h-[526px] md:my-[105px] md:h-[526px]"
          />
        </section>
      </main>
    </div>
